...
const Header = () => (
    <div className="d-flex justify-content-between align-items-center">
        <div>
            <svg width="99px" height="42px" viewBox="0 0 99 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <g id="HiFi" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Desktop-HD-Copy" transform="translate(-64.000000, -64.000000)" fill="#FFFFFF" fillRule="nonzero">
        ...
        <div className="d-lg-none">
            <svg width="27px" height="23px" viewBox="0 0 27 23" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <g id="HiFi" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Mobile" transform="translate(-277.000000, -25.000000)" fill="#FFBC00" fillRule="nonzero">
                        <g id="☰" transform="translate(277.000000, 25.000000)">
                            <path d="M27,4 L-3.55271368e-15,4 L-3.55271368e-15,-2.79776202e-14 L27,-2.79776202e-14 L27,4 Z M27,14 L-3.55271368e-15,14 L-3.55271368e-15,10 L27,10 L27,14 Z M27,23 L-3.55271368e-15,23 L-3.55271368e-15,19 L27,19 L27,23 Z"></path>
                        </g>
                    </g>
                </g>
            </svg>
