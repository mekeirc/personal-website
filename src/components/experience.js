...
import { Contracts, Perms, JobList } from "../constants";
...
const RoleCard = ({ role, company, duration, location, type, description, tags }) => (
	<div className="col-12 col-lg-6 col-xl-4 p-2">
		<CardBase className="p-3 h-100">
			<div className="row">
				<div className="col-12">
					<Paragraph color="black" className="mb-0">{role}</Paragraph>
				</div>
				<div className="col-12">
