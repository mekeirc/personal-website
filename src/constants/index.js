...
export const Perms = [
	...
	},
	{
		...
		text: "After a downsize in the company I looked at other roles where I could provide value. In this role I managed internal infrastructure, handled equipment maintainence and repair, provided hardware & software support for developers, set up testing stations for dev/design and managed various admin subscriptions.",
		tags: [
			{
				name: "INFRASTRUCTURE",
				color: "black",
